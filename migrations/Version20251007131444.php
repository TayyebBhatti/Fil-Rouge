 ...
 */
final class Version20251007131444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD utilisateur_id INT DEFAULT NULL, ADD lieu_id INT DEFAULT NULL, ADD categorie_id INT NOT NULL');
